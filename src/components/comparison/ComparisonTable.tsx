        ...
        <span className="flex items-center gap-1">
          ...
          {tooltip && (
            <span className="relative group/tooltip inline-flex items-center">
              <span
                aria-label="info"
                className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full border border-slate-400 dark:border-slate-500 text-slate-400 dark:text-slate-500 text-[9px] font-bold cursor-help leading-none select-none shrink-0"
              >
                i
              </span>
              <span className="pointer-events-none absolute left-full top-1/2 -translate-y-1/2 ml-2 w-52 rounded-lg bg-slate-900 px-3 py-2 text-[11px] text-white leading-snug shadow-xl opacity-0 group-hover/tooltip:opacity-100 transition-opacity duration-150 z-[9999] normal-case font-normal whitespace-normal">
                {tooltip}
